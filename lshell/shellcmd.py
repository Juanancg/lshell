...
class ShellCmd(cmd.Cmd, object):
    ...
    def __getattr__(self, attr):
        ...
        print(f"{type(self.g_cmd)}, {type(self.g_line)}, {type(self.g_arg)}")
    ...
    def complete(self, text, state):
        ...
        if state == 0:
            ...
            elif len(line.split(" ")) > 1 and line.split(" ")[0] in self.conf["allowed"]:
    ...
    def help_help(self):
        """Print Help on Help"""
        self.stdout.write("Help! Help! Help! Help! " "Please contact your system's administrator.\n")
